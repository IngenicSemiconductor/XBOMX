...
#ifndef HARD_OMX_PLUGIN_H_

#define HARD_OMX_PLUGIN_H_
...
struct HardOMXPlugin : public OMXPluginBase {
    HardOMXPlugin();
    virtual ~HardOMXPlugin();
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(HardOMXPlugin);
};

}  // namespace android

#endif  // HARD_OMX_PLUGIN_H_
