...
av_cold int ff_msmpeg4_vc1_init(AVCodecContext *avctx)
{
  MpegEncContext *s = avctx->priv_data;
  ff_h263_decode_init(avctx);
  common_init(s);

  INIT_VLC_STATIC(&ff_msmp4_dc_luma_vlc[0], 8, 120,
		  &ff_table0_dc_lum[0][1], 8, 4,
		  &ff_table0_dc_lum[0][0], 8, 4, 838);
  INIT_VLC_STATIC(&ff_msmp4_dc_chroma_vlc[0], 8, 120,
		  &ff_table0_dc_chroma[0][1], 8, 4,
		  &ff_table0_dc_chroma[0][0], 8, 4, 668);
  INIT_VLC_STATIC(&ff_msmp4_dc_luma_vlc[1], 8, 120,
		  &ff_table1_dc_lum[0][1], 8, 4,
		  &ff_table1_dc_lum[0][0], 8, 4, 1218);
  INIT_VLC_STATIC(&ff_msmp4_dc_chroma_vlc[1], 8, 120,
		  &ff_table1_dc_chroma[0][1], 8, 4,
		  &ff_table1_dc_chroma[0][0], 8, 4, 912);

  INIT_VLC_STATIC(&ff_msmp4_mb_i_vlc, 8, 64,
		  &ff_msmp4_mb_i_table[0][1], 4, 2,
		  &ff_msmp4_mb_i_table[0][0], 4, 2, 318);
  return 0;
}
