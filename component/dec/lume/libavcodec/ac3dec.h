...
///@defgroup arrays aligned arrays
    ...
    DECLARE_ALIGNED(16, int, transform_coeffs)[AC3_MAX_CHANNELS][AC3_MAX_COEFS];   ///< transform coefficients
    DECLARE_ALIGNED(16, int, delay)[AC3_MAX_CHANNELS][AC3_BLOCK_SIZE];             ///< delay - added to the next block
    DECLARE_ALIGNED(16, int, window)[AC3_BLOCK_SIZE];                              ///< window coefficients
    DECLARE_ALIGNED(16, int, tmp_output)[AC3_BLOCK_SIZE];                          ///< temporary storage for output before windowing
    DECLARE_ALIGNED(16, int, output)[AC3_MAX_CHANNELS][AC3_BLOCK_SIZE];            ///< output after imdct transform and windowing
///@}
} AC3DecodeContext;
...
void ff_ac3_downmix_c(int32_t (*samples)[256], float (*matrix)[2],
