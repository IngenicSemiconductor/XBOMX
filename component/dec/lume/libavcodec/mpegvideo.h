...
typedef struct Picture{
  ...
  int32_t (*motion_3dot0_above)[2][4];		
  int8_t (*ref_3dot0_above)[2][4];		
#endif
    int32_t frm_info_slice_start_mb_base;
    int32_t *frm_info_slice_start_mb;
    uint32_t frm_info_ctrl_base;
    uint32_t frm_info_mv_base;
    int32_t *frm_info_ctrl;
    int32_t *frm_info_mv;
    /* define for vc1 */
    int32_t * frm_mv_addr;
    int32_t * frm_no_dir_mv;
    /**
     * halfpel luma planes.
     */
...
typedef struct mpeg4_common_stru {
  void *memmb1;
  void *dMB;
  void *loadfile;
}mpeg4_common_stru;
...
static inline void jz_update_block_index(MpegEncContext *s){
    const int block_size= 8>>s->avctx->lowres;
