                                  ...
                                  MPContext *mpctx)
{
    ...
    switch (action) {
    case M_PROPERTY_GET:
        *(loff_t *) arg = stream_tell(mpctx->demuxer->stream);
        return M_PROPERTY_OK;
    case M_PROPERTY_SET:
        M_PROPERTY_CLAMP(prop, *(loff_t *) arg);
        stream_seek(mpctx->demuxer->stream, *(loff_t *) arg);
        return M_PROPERTY_OK;
    }
                                    ...
                                    void *arg, MPContext *mpctx)
{
    ...
    switch (action) {
    case M_PROPERTY_GET:
        *(loff_t *) arg = mpctx->demuxer->stream->start_pos;
        return M_PROPERTY_OK;
    }
    return M_PROPERTY_NOT_IMPLEMENTED;
}
                                  ...
                                  MPContext *mpctx)
{
    ...
    switch (action) {
    case M_PROPERTY_GET:
        *(loff_t *) arg = mpctx->demuxer->stream->end_pos;
        return M_PROPERTY_OK;
    }
    return M_PROPERTY_NOT_IMPLEMENTED;
}
