/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ra8lbr_decode.c,v 1.1.1.1 2007/12/07 08:11:41 zpxu Exp $
 * 
    ...
    if (pSamplesOut != HXNULL)
    {
        ...
        for(n = 0; n  < framesToDecode; n++)
        {
            retVal = Gecko2Decode(pDec->pDecoder, pDec->pFlushData,
                                  0xFFFFFFFFUL, pSamplesOut + *pNumSamplesOut);
                     ...
                     UINT32      ulFlags)
{
    ...
    *pNumSamplesOut = 0;
    ...
    if (pDec->ulFramesToConceal != 0)
    {
        ...
        for (n = 0; n < framesToDecode; n++)
        {
            retVal = Gecko2Decode(pDec->pDecoder, inBuf, 0xFFFFFFFFUL, outBuf);
    ...
    else if (ulNumBytes % pDec->ulFrameSize == 0)
    {
        ...
        for (n = 0; n < framesToDecode; n++)
        {
            ...
            retVal = Gecko2Decode(pDec->pDecoder, inBuf, lostFlag, outBuf);
