/* ***** BEGIN LICENSE BLOCK *****   
 * Source last modified: $Id: cpl_table_3.h,v 1.1.1.1 2007/12/07 08:11:43 zpxu Exp $ 
 * 
...
/*-------------------------------------------------------------------------*
 *	FileName : cpl_table_3.h												   *
 *																		   *
 *	Forward declaration of  Huffman ancilliary lookup tables for 		   *
 *		cpl_table_3 of real audio decoder.								   *
 *																		   *
 *																		   *
 *-------------------------------------------------------------------------*/

#ifdef _HUFFMAN_TABLES_
#ifndef RA_TNI_CPL_TABLE_3_H
#define RA_TNI_CPL_TABLE_3_H

#include "huffmantable.h"

#define RA_TNI_CPL_TABLE_3_BIT_COUNT  4

extern const HuffmanTableNode RA_TNI_cpl_table_3[] ; 

#endif //RA_TNI_CPL_TABLE_3_H
