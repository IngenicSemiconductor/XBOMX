/* ***** BEGIN LICENSE BLOCK *****   
 * Source last modified: $Id: ra_tni.c,v 1.1.1.1 2007/12/07 08:11:46 zpxu Exp $ 
 * 
...
/*
 *  ======== RA_tni.c ========
 *  Implementation of required module init and exit method 
 *		for the RA_TNI module.
 */

#pragma CODE_SECTION(RA_TNI_init, ".text:init") 
#pragma CODE_SECTION(RA_TNI_exit, ".text:exit") 
