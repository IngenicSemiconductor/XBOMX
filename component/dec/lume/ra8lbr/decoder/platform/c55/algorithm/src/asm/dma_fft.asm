; ***** BEGIN LICENSE BLOCK *****   
; Source last modified: $Id: dma_fft.asm,v 1.1.1.1 2007/12/07 08:11:44 zpxu Exp $ 
;  
...
;-----------------------------------------------------------------------------------------------------------
; 	File 		:	dma_FFT.asm 
;   Description : C55X assembly routines for functions present in Fft.c WITH DMA support
;	
;------------------------------------------------------------------------------------------------------------
;/*
...
;		: XAR6 -> twidtab (long*) the correct one	
;		: T0 -> nsamples (short)
;
; Returns : void
;
...
;------------------------------------------------------------------------------------------------------------
	...
	.endif	; CONST_TABLE_DMA		 DMA enabled version
