/* ***** BEGIN LICENSE BLOCK *****   
 * Source last modified: $Id: cpl_table_2.c,v 1.1.1.1 2007/12/07 08:11:45 zpxu Exp $ 
 * 
...
/*-------------------------------------------------------------------------*
 *	FileName : cpl_table_2.c												   *
 *																		   *
 *	Huffman lookup table(s) generated by utility for huffman tree(s) 	   *
 *		cpl_table_2 of real audio decoder.									   *
 *																		   *
 *																		   *
 *  NOTE : CPL_TABLE_2_BIT_COUNT no. of bits should be read in the			   *
...
#pragma DATA_ALIGN( RA_TNI_cpl_table_2, 2 )	 // align on 32-bit boundary

const HuffmanTableNode RA_TNI_cpl_table_2[] = { 
	{  1 , 1  },
	{  1 , 1  },
	{  1 , 1  },
	{  1 , 1  },
