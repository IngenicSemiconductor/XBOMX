/* ***** BEGIN LICENSE BLOCK *****   
 * Source last modified: $Id: sqvh_table_1.h,v 1.1.1.1 2007/12/07 08:11:44 zpxu Exp $ 
 * 
...
/*-------------------------------------------------------------------------*
 *	FileName : sqvh_table_1.h												   *
 *																		   *
 *	Forward declaration of  Huffman ancilliary lookup tables for 		   *
...
#ifndef RA_TNI_SQVH_TABLE_1_H
#define RA_TNI_SQVH_TABLE_1_H

#include "huffmantable.h"

#define RA_TNI_SQVH_TABLE_1_BIT_COUNT  8

extern const HuffmanTableNode RA_TNI_sqvh_table_1[] ; 

#endif //RA_TNI_SQVH_TABLE_1_H
