/* ***** BEGIN LICENSE BLOCK *****   
 * Source last modified: $Id: radec_hufftabs.c,v 1.1.1.1 2007/12/07 08:11:48 zpxu Exp $ 
 * 
...
#pragma section const .hufftabs
#endif
const SHuffInfo huffTabCoupleInfo[5] = {
	/* table 0 = unused */
	/* table 1 = unused */
...
const SHuffInfo huffTabPowerInfo[13] = {
...
const SHuffInfo huffTabVectorInfo[7] = {
