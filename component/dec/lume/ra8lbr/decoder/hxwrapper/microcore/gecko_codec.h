 ...
 *
 * ***** END LICENSE BLOCK ***** */
#ifndef GECKO_CODEC_H
#define GECKO_CODEC_H
...
//#ifdef GECKO2_ARM
//#include "gecko2codecshim.h"
//#endif

class npGeckoCodec : public npAudioCodec
{
public:
    npGeckoCodec();
    virtual ~npGeckoCodec();
