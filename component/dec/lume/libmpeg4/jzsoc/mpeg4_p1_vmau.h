...
/*MC FIFO*/
#define VMAU_MC_Y1 (VMAU_V_BASE+0x4000)
#define VMAU_MC_Y2 (VMAU_MC_Y1+0x100)

#define VMAU_MC_C1 (VMAU_V_BASE+0x4500)
#define VMAU_MC_C2 (VMAU_MC_C1+0x80)
#endif
