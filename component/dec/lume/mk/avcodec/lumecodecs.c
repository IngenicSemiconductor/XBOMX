 ...
 */
#ifdef VIDEO_CODEC
void video_avcodec_register_all(int isvp)
{
    /* video codecs */
...
#endif
#ifdef AUDIO_CODEC
void audio_avcodec_register_all(int cooknplaying)
{
    /* audio codecs */
