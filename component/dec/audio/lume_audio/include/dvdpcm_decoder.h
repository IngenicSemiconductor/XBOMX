 ...
 * -------------------------------------------------------------------
 */
#ifndef DVDPCM_DECODER_H_INCLUDED
#define DVDPCM_DECODER_H_INCLUDED
...
class DvdpcmDecoder: public mpDecorder
{
public:
	
	DvdpcmDecoder();
	virtual ~DvdpcmDecoder();	
...
#endif  //#ifndef DVDPCM_DECODER_H_INCLUDED
