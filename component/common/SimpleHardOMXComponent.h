...
#ifndef SIMPLE_HARD_OMX_COMPONENT_H_

#define SIMPLE_HARD_OMX_COMPONENT_H_
...
struct SimpleHardOMXComponent : public HardOMXComponent {
    SimpleHardOMXComponent(
            const char *name,
...
private:
    ...
    sp<ALooper> mLooper;
    sp<AHandlerReflector<SimpleHardOMXComponent> > mHandler;
    ...
    DISALLOW_EVIL_CONSTRUCTORS(SimpleHardOMXComponent);
};

}  // namespace android

#endif  // SIMPLE_HARD_OMX_COMPONENT_H_
