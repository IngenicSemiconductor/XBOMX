...
#ifndef HARD_OMX_COMPONENT_H_

#define HARD_OMX_COMPONENT_H_
...
struct HardOMXComponent : public RefBase {
    HardOMXComponent(
            const char *name,
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(HardOMXComponent);
};

}  // namespace android

#endif  // HARD_OMX_COMPONENT_H_
