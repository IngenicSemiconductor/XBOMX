...
{
  //  printf("x264_weight_plane_analyse\n");
    int x,y;
    uint32_t sad = 0;
    uint64_t ssd = 0;
...
{
  //  printf("x264_weight_cost_init_luma\n");
...
static int x264_slicetype_frame_cost( x264_t *h, x264_mb_analysis_t *a,
                                      ...
                                      int b_intra_penalty )
{
  //  printf("x264_slicetype_frame_cost\n");
    int i_score = 0;
...
{
  //  printf("x264_slicetype_frame_cost_recalculate\n");
    int i_score = 0;
    int *row_satd = frames[b]->i_row_satds[b-p0][p1-b];
...
{
  //  printf("x264_macroblock_tree_finish\n");
    int mb_index;
    x264_emms();
...
{
  //  printf("x264_slicetype_path_cost\n");
    int loc = 1;
    int cost = 0;
    int cur_p = 0;
