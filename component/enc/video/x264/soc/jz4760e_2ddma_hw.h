...
#define DDMA_GP0_V_BASE gp0_base
#define DDMA_GP1_V_BASE gp1_base
#define DDMA_GP2_V_BASE gp2_base
...
#define set_gp1_dha(dha) \
  ((volatile int* *)(DDMA_GP1_V_BASE+DDMA_GP_DHA_OFST))[0]=((volatile int*) dha);
...
#define set_gp2_dha(dha) \
  ((volatile int*)(DDMA_GP2_V_BASE+DDMA_GP_DHA_OFST))[0]=((volatile int)dha);
